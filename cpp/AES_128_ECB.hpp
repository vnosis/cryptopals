#ifndef AES_128_ECB_H
#define AES_128_ECB_H
#include <string>
#include <fstream>
#include <iostream>
...
{
private:
    const std::vector<std::vector<uint8_t>> s_box_vector{{0x63, 0x7c, 0x77, 0x7b, 0xf2, 0x6b, 0x6f, 0xc5, 0x30, 0x01, 0x67, 0x2b, 0xfe, 0xd7, 0xab, 0x76},
    ...
    std::vector<uint8_t> round_Constants{0x01,0x02,0x04,0x08,0x10,
